...
### 重要声明
**本项目基于 hyuan42 的 Rime-words-counter，但原项目并未提供任何开源许可证。根据版权法，这意味着原代码默认“保留所有权利”。本仓库的发布是出于学习和技术交流目的进行的优化分享。本仓库中添加的 LICENSE 文件（MIT License）仅适用于本人原创和修改的部分代码，不适用于原作者的代码。如果原作者hyuan42对此有任何异议，请联系我，我会立即删除本仓库。**
